...
class PodcastDB:
    ...
    def search_episodes(self,word,n_outputs=3,n_episodes=1,n_most_recent=10,verbose=False):
        ...
        sorted_eps = [np.array([self.comparator(u,v) for v in ev]).argsort()[:n_episodes] for ev in ep_vec]
